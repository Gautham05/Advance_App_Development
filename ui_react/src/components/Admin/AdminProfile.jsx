...
const AdminProfile = () => {
  ...
  useEffect(() => {
    // Fetch admin's details from local storage or API
    const storedFullName = localStorage.getItem('adminFullName');
    const storedEmail = localStorage.getItem('adminEmail');
    const storedUsername = localStorage.getItem('adminUsername');
    const storedProfileImage = localStorage.getItem('adminProfileImage');
    const storedDateOfBirth = localStorage.getItem('adminDateOfBirth');
  ...
  const handleFullNameChange = (e) => {
    ...
    localStorage.setItem('adminFullName', e.target.value);
  };
  ...
  const handleUsernameChange = (e) => {
    ...
    localStorage.setItem('adminUsername', e.target.value);
  };
  ...
  const handleDateOfBirthChange = (e) => {
    ...
    localStorage.setItem('adminDateOfBirth', e.target.value);
  };

  const handleGenderChange = (e) => {
    setGender(e.target.value);
    localStorage.setItem('adminGender', e.target.value);
  };
  ...
  const handleAddressChange = (e) => {
    ...
    localStorage.setItem('adminAddress', e.target.value);
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-md overflow-y-auto mt-10">
