...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-gray-200 to-purple-300 text-center text-white ">
    <div className="container pt-4">
      ...
      <div
      className=" bg-gradient-to-r from-gray-200 to-purple-300  pb-2 text-center text-black ">
